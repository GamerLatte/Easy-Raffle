...
public class RafflerLiteWindow : Window, IDisposable
{
	...
	public RafflerLiteWindow(Plugin plugin, MainWindow mainWindow, TicketListWindow ticketListWindow)
		: base("Raffler Lite", (ImGuiWindowFlags)24, false)
	{
		this.plugin = plugin;
