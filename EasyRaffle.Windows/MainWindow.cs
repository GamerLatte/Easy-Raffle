...
public class MainWindow : Window, IDisposable
{
	...
	private readonly EasyRaffleLiteWindow? liteWindow;
	...
	public MainWindow(Plugin plugin, string raffleImgArg, TicketListWindow ticketListWindow, EasyRaffleLiteWindow? liteWindow)
		: base("Easy Raffle##Main", (ImGuiWindowFlags)24, false)
	{
	...
	public override void Draw()
	{
		...
		try
		{
			...
			ImGui.TextUnformatted(ImU8String.op_Implicit("Welcome to Easy Raffle!"));
