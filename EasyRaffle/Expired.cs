...
public class Expired
{
	...
	public void Draw()
	{
		...
		if (!ShouldClose)
		{
			...
			ImGui.Begin(ImU8String.op_Implicit("Easy Raffle - Plugin Expired"), (ImGuiWindowFlags)98);
			ImGui.TextWrapped(ImU8String.op_Implicit("\ud83c\udf89 Thank you for using Easy Raffle!"));
			ImGui.Spacing();
